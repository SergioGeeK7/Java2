...
public class AdminController {
	...
	public String saveAdmin(@ModelAttribute("admin") Admin adminForm, Model model, RedirectAttributes rd,
	...
	public String delete(@PathVariable("idAdmin") int id, RedirectAttributes rd) {
